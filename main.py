...
# Load the ball image
ball_image = pygame.image.load("Airplane.png")  # Replace with your image path for the ball
...
while True:
    ...
    if level == 1:
        PIPE_COLOR = (0, 0, 225)  # blue pipes for Level 1
    elif level == 2:
        PIPE_COLOR = (0, 225, 0)  # green pipes for Level 2
    elif level == 3:
